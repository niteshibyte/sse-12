                    ...
                    {visible &&
                        <Drawer className="drawer--mobile" maxWidth={false}>
                            ...
                            <List className="site--menu mobile--menu">
                                ...
                                {data?.main_menu && data?.main_menu?.length > 0 && data?.main_menu?.map((item: any) => {
                                    return (
                                        <List.Li className={showMegaMenu == item?.title ? "has--drop--menu active--mega--menu" : "has--drop--menu"}>
