import { Button, Container, List, Stack, Text, Textfield, Toggle } from "@wonderflow/react-components";
...
export const PopupButton = (props: any) => {
    ...
    return (
        <>
            {props.popupButton &&
                <Button dimension="big" className="" type="submit" onClick={() => setVisible(true)}>{props.popupButton}</Button>
            }
            {/* WhitePaper Modal */}
                        ...
                        <Stack as="div" direction="row" className="webform--form--block form popup--form">
                            ...
                            <form action="https://webto.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8" method="POST">
                                ...
                                <Stack as="div" columnGap={32} vPadding={32} hPadding={48}>
                                    <Text as="h4" variant="heading-4" className="mb-8">{props?.title}</Text>
                                </Stack>
                            ...
                            <Stack as="div" className='toggleSwitch mt-4'  vPadding={16} hPadding={48}>
                                <Toggle required label="Subscribe to the Newsletter" />
                            </Stack>
