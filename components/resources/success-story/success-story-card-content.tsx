...
export const SuccessStoryCardContent = (props: any) => {
    return (
        <>
            <Stack as="div" direction="column" rowGap={64} className="articles--block">
                <Card className="card--block" padding={false} bordered highlightOnHover>
                    <Stack direction="row" wrap as="div" vAlign="center">
                        ...
                        <Stack as="div" className="card--body" rowGap={16} vPadding={24} hPadding={32}>
