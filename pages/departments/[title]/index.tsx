...
import {  Spinner, Stack, useBreakpointsConfig } from '@wonderflow/react-components';
...
import { DepartmentFeedback } from '../../../components/departments/feedback';
        ...
        <>
            {loading ?<Loader  height='100vh' width='100vw' /> :
                <Stack as="div">
                    ...
                    <Stack direction="column" rowGap={value.rowGap} className='white--theme bg--grey industry-page'>
                        <Header />
...
export const getServerSideProps = async (context: any) => {
    const data = await containtStact.getDepartmentData("department_page1", `/departments/${context.query. title}`,`${context.query.lang}`)
    return {
        props: {
            data,
        },
